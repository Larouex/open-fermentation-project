...
This is the core system configuration file named: <a href="./src/config.json">config.json</a> and let's go through all of the details from the top of the file and work our way down...
