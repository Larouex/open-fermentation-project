...
The \*_tracking_ table represents the lifecycle of the recipe. When the database and trackig table are created, the table is populated a row that represents every hour of the recipe.
...
- **Cycle Time Toggle** - The 1 represents measurement in _Hours_
